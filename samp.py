...
ADDR_VEHICLE_COLOR           = 0x434         # Vehicle Primary Color
ADDR_VEHICLE_COLOR2          = 0x435         # Vehicle Secondary Color
ADDR_WANTED                  = 0x58DB60      # Player Wanted Level
ADDR_WEAPON                  = 0xBAA410      # Player Weapon Offset
ADDR_WIDTH                   = 0xC9C040
...
ADDR_RED_MARKER 			 = (0xC7DEC8, 0xC7DECC, 0xC7DED0)
...
aircraft_models = (417, 425, 447, 460, 469, 476, 487, 488, 497, 511, 512, 513,
                   519, 520, 548, 553, 563, 577, 592, 593)
bike_models = (481, 509, 510)
boat_models = (430, 446, 452, 453, 454, 472, 473, 484, 493, 539, 595)
unmanned_models = (435, 441, 449, 450, 464, 465, 501, 564, 569, 570, 584, 590,
                   591, 594, 606, 607, 608, 610, 611)
...
weather_names = ("EXTRASUNNY_LA", "SUNNY_LA", "EXTRASUNNY_SMOG_LA",
                 ...
                 "EXTRASUNNY_VEGAS", "CLOUDY_VEGAS", "EXTRASUNNY_COUNTRYSIDE",
                 "SUNNY_COUNTRYSIDE", "CLOUDY_COUNTRYSIDE",
                 "RAINY_COUNTRYSIDE", "EXTRASUNNY_DESERT", "SUNNY_DESERT",
                 "SANDSTORM_DESERT", "UNDERWATER", "EXTRACOLOURS_1",
                 "EXTRACOLOURS_2")
weapon_id_for_model = {1:331, 2:333, 3:334, 4:335, 5:336, 6:337, 7:338, 8:339,
                       9:341, 10:321, 11:322, 12:323, 13:324, 14:325, 15:326,
                       16:342, 17:343, 18:344, 22:346, 23:347, 24:348, 25:349,
                       26:350, 27:351, 28:352, 29:353, 30:355, 31:356, 32:372,
                       33:357, 34:358, 35:359, 36:360, 37:361, 38:362, 39:363,
                       40:364, 41:365, 42:366, 43:367, 44:368, 45:369, 46:371}

# SAMP Offsets
ADDR_SAMP_INCHAT_PTR                 = 0x21A10C  # R1 0x21a10c   R2 0x21A114 R3 0x21A1F4 R4 0x21A124
ADDR_SAMP_INCHAT_PTR_OFF             = 0x55      # R1 0x55    R2 0x60
ADDR_SAMP_USERNAME                   = 0x219A6F  # R1 0x219A6F, R2 0x219A77 R3 0x26E03F R4 0x26E16F
FUNC_SAMP_SENDCMD                    = 0x69190   # R1 0x65c60  R2 0x65d30 R3 0x69110 R4 0x698C0
FUNC_SAMP_SENDSAY                    = 0x69190    # R1 0x57f0  R2 0x57e0 R3 0x5820 R4 0x5A00
FUNC_SAMP_ADDTOCHATWND               = 0x67460   # R1 0x64010 R2 0x640E0 R3 0x67460 R4 0x67BA0
ADDR_SAMP_CHATMSG_PTR                = 0x21A0E4  # R1 0x21A0E4 R2 0x21A0EC, R4 0x26E9F8
FUNC_SAMP_SHOWGAMETEXT               = 0x9C2C0 # R2 0x9C370 R4 0xA0D10
FUNC_SAMP_PLAYAUDIOSTR               = 0x62da0 # R2 0x62E70 R4 0x66920
FUNC_SAMP_STOPAUDIOSTR               = 0x629a0 # R2 0x62A70 R4 0x66520
SAMP_DIALOG_STRUCT_PTR               = 0x21A0B8   # R1 0x21A0B8 R2 0x21a0c0 R3 0x26E898 R4 0x26E9C8
SAMP_DIALOG_PTR2_OFFSET 			 = 0x20 # R2 same
SAMP_DIALOG_LINECOUNT_OFFSET		 = 0x150 # R2 same
SAMP_DIALOG_OPEN_OFFSET				 = 0x28 # R2 same
SAMP_DIALOG_STYLE_OFFSET			 = 0x2C # R2 same
SAMP_DIALOG_ID_OFFSET				 = 0x30 # R2 same
SAMP_DIALOG_TEXT_PTR_OFFSET			 = 0x34 # R2 same
SAMP_DIALOG_CAPTION_OFFSET			 = 0x40 # R2 same
FUNC_SAMP_SHOWDIALOG                 = 0x6B9C0  # R1 0x6B9C0;  R2 0x6BA70 R3 0x6F8C0 R4 0x6FFE0
FUNC_SAMP_CLOSEDIALOG                = 0x6B210  # R1 0x6B210;  R2 0x6B2C0 R3 0x6F110 R4 0x6F830
FUNC_SAMP_PRESSBUTTON                = 0x6C040  # R1 0x6C040;  R2 0x6C0F0 R3 0x6FF40 R4 0x70660
FUNC_SAMP_SENDDIALOG                 = 0x30B30  # R1 0x30B30;  R2 0x30C10 R3 0x33EE0 R4 0x345D0
FUNC_SAMP_DELETE_TEXTLABEL           = 0x12D0   # R1 0x12D0;   R2 0x12E0 R3 0x12D0 R4 0x12E0
FUNC_SAMP_CREATE_TEXTLABEL           = 0x11C0   # R1 0x11C0;   R2 0x11D0 R3 0x11C0 R4 0x11D0
SAMP_PLAYER_COLOR_OFFSET             = 0x216378 # R1 0x216378; R2 0x216380
SAMP_FUNC_TEXTDRAW                   = 0x1AE20  # R1 0x1AE20;  R2 0x1AF00 R3 0x1E1C0 R4 0x1E8C0
FUNC_SAMP_DELETE_TEXTDRAW            = 0x1AD00  # R1 0x1AD00;  R2 0x1ADE0 R3 0x1E0A0 R4 0x1E7A0
FUNC_UPDATESCOREBOARD                = 0x8A10   # R1 0x8A10 R2 0x8A20 R3 0x8BA0 R4 0x8F00
SAMP_INFO_OFFSET                     = 0x21A0F8 # R1 0x21A0F8, R2 0x21A100, R4 0x26EA0C
SAMP_POOLS						     = 0x3CD  # R1 3CD, R2 3C5, R4 0x3DE
SAMP_POOL_TEXTLABEL					 = 0xC   # R1 0xC, R2 0x1C
SAMP_POOL_TEXTDRAW					 = 0x10  # R1 0x10, R2 0x20, R4 0x20
SAMP_TEXTDRAW_XPOS 					 = 0x98B
SAMP_TEXTDRAW_YPOS 					 = 0x98F
SAMP_PPOOL_PLAYER_OFFSET             = 0x18     # R1  0x18, R2 0x8, R4 0x8
SAMP_SLOCALPLAYERID_OFFSET           = 0x4      # R1 0x4, R2 0x0
SAMP_ISTRLEN_LOCALPLAYERNAME_OFFSET  = 0x1A # R2 0x16
SAMP_SZLOCALPLAYERNAME_OFFSET        = 0xA # R2 0x6
SAMP_PSZLOCALPLAYERNAME_OFFSET       = 0xA # R2 0x6
...
SAMP_ILOCALPLAYERPING_OFFSET         = 0x26 # R2 0x33
SAMP_ILOCALPLAYERSCORE_OFFSET        = 0x2A # R2 0x22
SAMP_IPING_OFFSET                    = 0x28  # R2 0x4
SAMP_ISCORE_OFFSET                   = 0x24 # R2 0x0
SAMP_REMOTEPLAYER_DATA               = 0x0 #R2 below
SAMP_PLAYER_ACTOR                    = 0x0 #R2 below
SAMP_PED_DATA                        = 0x2A4 #R2 below
...
VERSION_R1_R2 = 0xD3982
VERSION_R3_R4 = 0xE5982

samp_version = 2;
# 0 - default (0.3.7-R1), 1 - R2, 2 - R3, 3 - R4
...
def set_version():
    global samp_version
    r1_r2 = read_string(h_gta, dw_samp + VERSION_R1_R2, 8)
    if r1_r2 == "0.3.7 {F":
        samp_version = 0
    elif r1_r2 == "0.3.7-R2":
        samp_version = 1
    else:
        r3_r4 = read_string(h_gta, dw_samp + VERSION_R3_R4, 8)
        if r3_r4 == "0.3.7-R3":
            samp_version = 2
        elif r3_r4 == "0.3.7-R4":
            samp_version = 3
        else:
            print("Version unknown, using 0.3.7-R1 offsets")


def set_offsets():
    global ADDR_SAMP_INCHAT_PTR 	
    global ADDR_SAMP_INCHAT_PTR_OFF
    global ADDR_SAMP_USERNAME 		
    global FUNC_SAMP_SENDCMD 		
    global FUNC_SAMP_SENDSAY 		
    global SAMP_DIALOG_STRUCT_PTR 	
    global FUNC_SAMP_SHOWDIALOG      
    global FUNC_SAMP_CLOSEDIALOG     
    global FUNC_SAMP_PRESSBUTTON     
    global FUNC_SAMP_SENDDIALOG         
    global FUNC_SAMP_DELETE_TEXTLABEL
    global FUNC_SAMP_CREATE_TEXTLABEL
    global SAMP_PLAYER_COLOR_OFFSET  
    global SAMP_FUNC_TEXTDRAW        
    global FUNC_SAMP_DELETE_TEXTDRAW 
    global FUNC_UPDATESCOREBOARD     
    global SAMP_INFO_OFFSET          		
    global SAMP_POOLS				
    global SAMP_POOL_TEXTLABEL		
    global SAMP_POOL_TEXTDRAW		
    global SAMP_PPOOL_PLAYER_OFFSET  
    global SAMP_SLOCALPLAYERID_OFFSET
    global SAMP_PREMOTEPLAYER_OFFSET 
    global SAMP_ISTRLENNAME_OFFSET   
    global SAMP_SZPLAYERNAME_OFFSET  
    global SAMP_PSZPLAYERNAME_OFFSET  
    global FUNC_SAMP_ADDTOCHATWND
    global ADDR_SAMP_CHATMSG_PTR
    global SAMP_REMOTEPLAYER_DATA
    global SAMP_PLAYER_ACTOR
    global SAMP_PED_DATA
    global SAMP_ISTRLEN_LOCALPLAYERNAME_OFFSET  
    global SAMP_SZLOCALPLAYERNAME_OFFSET        
    global SAMP_PSZLOCALPLAYERNAME_OFFSET       
    global SAMP_PREMOTEPLAYER_OFFSET            
    global SAMP_ISTRLENNAME_OFFSET              
    global SAMP_SZPLAYERNAME_OFFSET             
    global SAMP_PSZPLAYERNAME_OFFSET            
    global SAMP_ILOCALPLAYERPING_OFFSET         
    global SAMP_ILOCALPLAYERSCORE_OFFSET        
    global SAMP_IPING_OFFSET                    
    global SAMP_ISCORE_OFFSET                   
    global SAMP_ISNPC_OFFSET
    global FUNC_SAMP_SHOWGAMETEXT
    global FUNC_SAMP_PLAYAUDIOSTR
    global FUNC_SAMP_STOPAUDIOSTR
    if samp_version == 1:                    # 0.3.7-R2
        FUNC_SAMP_ADDTOCHATWND               = 0x640E0
        ADDR_SAMP_CHATMSG_PTR                = 0x21A0EC
        ADDR_SAMP_INCHAT_PTR 				 = 0x21a114
        ADDR_SAMP_INCHAT_PTR_OFF			 = 0x60
        ADDR_SAMP_USERNAME 					 = 0x219A77
        FUNC_SAMP_SENDCMD 					 = 0x69190
        FUNC_SAMP_SENDSAY 					 = 0x69190
        SAMP_DIALOG_STRUCT_PTR 				 = 0x21a0c0
        FUNC_SAMP_SHOWDIALOG                 = 0x6BA70
        FUNC_SAMP_CLOSEDIALOG                = 0x6B2C0
        FUNC_SAMP_PRESSBUTTON                = 0x6C0F0
        FUNC_SAMP_SENDDIALOG                 = 0x30C10
        FUNC_SAMP_DELETE_TEXTLABEL           = 0x12E0
        FUNC_SAMP_CREATE_TEXTLABEL           = 0x11D0
        SAMP_PLAYER_COLOR_OFFSET             = 0x216380
        SAMP_FUNC_TEXTDRAW                   = 0x1AF00
        FUNC_SAMP_DELETE_TEXTDRAW            = 0x1AEC0
        FUNC_UPDATESCOREBOARD                = 0x8A20
        SAMP_INFO_OFFSET                     = 0x21A100
        SAMP_POOLS						     = 0x3C5
        SAMP_POOL_TEXTLABEL					 = 0x1C
        SAMP_POOL_TEXTDRAW					 = 0x20
        SAMP_PPOOL_PLAYER_OFFSET             = 0x8
        SAMP_SLOCALPLAYERID_OFFSET           = 0x0
        SAMP_PREMOTEPLAYER_OFFSET            = 0x26
        SAMP_ISTRLENNAME_OFFSET              = 0x24
        SAMP_SZPLAYERNAME_OFFSET             = 0x14
        SAMP_PSZPLAYERNAME_OFFSET            = 0x14
        SAMP_REMOTEPLAYER_DATA               = 0xC
        SAMP_PLAYER_ACTOR                    = 0x1C
        SAMP_PED_DATA                        = 0x40
...
def get_player_hp():
    ''' Return the local player's HP as a float.
    '''
    if not check_handles():
        return -1
...
def get_player_armor():
    ''' Return the local player's armor as a float.
    '''
    if not check_handles():
        return -1
    dw_cpedptr = read_dword(h_gta, ADDR_CPED_PTR)
...
def get_coordinates():
    ''' Return the local player's coordinates as a list of floats (x, y, z).
    '''
    if not check_handles():
        return -1
...
def get_red_marker():
    ''' Return the coordinates of the red cylindric marker.
    '''
    if not check_handles():
        return -1
    coords = [0, 0, 0]
    for i in range(3):
        coords[i - 1] = read_float(h_gta, ADDR_RED_MARKER[i - 1])
    if coords == [0, 0, 0]:
        return -1
    return coords
...
def get_distance(coords1, coords2):
    ''' Return the distance between two vectors as a float.
    Arguments:
    First argument - first vector as a list of floats.
    Second argument - second vector as a list of floats.
    
    >>> get_distance([0.456, 1.342, 0.234], [1.0, 0.0, 1.0])
    1.6381868025350468
    '''
    vect_diff = [0, 0, 0]
...
def get_player_money():
    ''' Return local player's money as an integer.
    '''
    if not check_handles():
        return -1
...
def get_player_skin():
    ''' Return local player's skin ID as an integer.
    '''
    if not check_handles():
        return -1
    dw_cpedptr = read_dword(h_gta, ADDR_CPED_PTR)
...
def add_chat_message(wtext, color = 'FFFFFF', timestamp = True):
    ...
    while True:
        '''
        This cycle tries to fix the bug, where a chat line is replaced by 'V'.
        It is the result of new lines adding very quickly.
        Here it replaces the bugged strings with their chatlog counterparts.
        Still, there is a ~10% chance you will lose the line and a wrong
        chatlog line would be added.
        '''
...
def refresh_scoreboard():
    ...
    for xx in range(4):
        ...
        if len(offs) > 4:
            ...
            offs = offs[:2] + offs[4:]
    inject_data[10] = 0xC3
    windll.kernel32.WriteProcessMemory(h_gta, p_inject_func, inject_data, 11,
                                       0)
...
def get_id_by_ped(ped):
    ...
    for i in range(SAMP_PLAYER_MAX):
        ...
        if dw_remoteplayer == 0:
            continue
        dw_remoteplayer_data = read_dword(h_gta, dw_remoteplayer + 
                                          SAMP_REMOTEPLAYER_DATA)
        if dw_remoteplayer_data == 0:
            continue
        dw_samp_actor = read_dword(h_gta, dw_remoteplayer_data + 
                                   SAMP_PLAYER_ACTOR)
        if dw_samp_actor == 0:
            continue
        dw_ped = read_dword(h_gta, dw_samp_actor + SAMP_PED_DATA)
        if dw_ped == ped:
            return i
    return -1
...
def get_ped_by_id(plid):
    ...
    dw_remoteplayer_data = read_dword(h_gta, dw_remoteplayer +
                                      SAMP_REMOTEPLAYER_DATA)
    dw_samp_actor = read_dword(h_gta, dw_remoteplayer_data + SAMP_PLAYER_ACTOR)
    return read_dword(h_gta, dw_samp_actor + SAMP_PED_DATA)
...
def create_text_label(text, color, xpos, ypos, zpos, draw_dist = 46.0,\
    ...
    for i in range(SAMP_MAX_TEXTLABELS - 1):
        ...
        ret = call(h_gta, dw_samp + FUNC_SAMP_CREATE_TEXTLABEL,
                   [['i', dw_address], ["i", SAMP_MAX_TEXTLABELS - i], 
                    ["s", text], ["i", color], ["f", xpos], ["f", ypos],
                    ["f", zpos], ["f", draw_dist], ["i", test_los], 
                    ["i", player], ["i", vehicle]], False, True)   
        if not ret:
            return -1
...
def create_text_draw(text, xPos, yPos, letterColor = 0xFFFFFFFF, font = 3,
            ...
            proportional = 1, modelID = 0, xRot = 0.0, yRot = 0.0, zRot = 0.0,
            zoom = 1.0, color1 = 0xFFFF, color2 = 0xFFFF):
    ...
    for i in range(2048):
        ...
        if not windll.kernel32.WriteProcessMemory(h_gta, p_param5, rstruct,
                                                  len(rstruct), 0):
            return -1
...
def delete_text_draw(index):
    ...
    dw_address = read_dword(h_gta, dw_address + SAMP_POOLS)
    dw_txtdr = read_dword(h_gta, dw_address + SAMP_POOL_TEXTDRAW)
    if not call(h_gta, dw_samp + FUNC_SAMP_DELETE_TEXTDRAW, [["i", dw_txtdr],
                                                             ["i", index]],
                False, True):
        return -1
    return index
...
def get_text_draw_pos(tdid):
    ...
    if dw_tdid == 0:
        return pos
    pos[0] = read_float(h_gta, dw_tdid + SAMP_TEXTDRAW_XPOS)
    pos[1] = read_float(h_gta, dw_tdid + SAMP_TEXTDRAW_YPOS)
    return pos
...
def set_text_draw_pos(tdid, xpos, ypos):
    ...
    if dw_tdid == 0:
        dw_tdid = read_dword(h_gta, dw_txtdr + (tdid * 4 + (4 *
                        (SAMP_MAX_PLAYERTEXTDRAWS + SAMP_MAX_TEXTDRAWS * 2))))
    return write_mem(h_gta, dw_tdid + SAMP_TEXTDRAW_XPOS, xpos, 'float')                   \
     and write_mem(h_gta, dw_tdid + SAMP_TEXTDRAW_YPOS, ypos, 'float')
